<template>
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="视频名称" prop="shipinmingcheng">
					<el-input v-model="ruleForm.shipinmingcheng" placeholder="视频名称" clearable  :readonly="ro.shipinmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="视频名称" prop="shipinmingcheng">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.xuexishipin" label="学习视频" prop="xuexishipin">
					<file-upload
						tip="点击上传学习视频"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.xuexishipin" label="学习视频" prop="xuexishipin">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 15px","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"4px","background":"#18c1b9","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.xuexishipin)">预览</el-button>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="!ruleForm.xuexishipin" label="学习视频" prop="xuexishipin">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="视频简述" prop="shipinjianshu">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="视频简述"
					  v-model="ruleForm.shipinjianshu" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.shipinjianshu" label="视频简述" prop="shipinjianshu">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.shipinjianshu}}</span>
				</el-form-item>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='shipinjianshu'){
							this.ruleForm.shipinjianshu = obj[o];
							this.ro.shipinjianshu = true;
							continue;
						}
						if(o=='fabushijian'){
